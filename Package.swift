...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Tealeaf",
            url: "https://github.com/acoustic-analytics/Tealeaf/releases/download/10.6.263/Tealeaf_XCFramework_Release.zip",
            checksum: "5f56af51316c2eae5b6e90794cb74a83dfabe3d87283da08e41d1970101add15"),
        .binaryTarget(
            name: "EOCore",
